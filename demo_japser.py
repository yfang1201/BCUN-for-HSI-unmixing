...
class DEMO(object):
    ...
    def __init__(self, argin, verbose):
        ...
        if argin[3] == 'AEsmm_mse':
             ...
             self.ee = AEsmm_mse([self.data, self.nRow, self.nCol, self.nBand, self.nPixel, self.p, iterEM, iters,
                              INPUT, pad, OPT_OVER, LR, tv_weight, OPTIMIZER, NET_TYPE,
                              self.data.transpose(1,0),
    ...
    def load_data(self, data_loc):
        ...
        self.data_cube = pkg_data['japser_norm_cube']
    ...
    def estVAR(self):
        ROI = np.reshape(self.data_cube[40:49, 31:46,:], (9*15, 198))
...
if __name__ == '__main__':
    ...
    result_path = "/mnt/Data/SU/data_results/Jaspser/results" # + str(i+1)
    #pdb.set_trace()
    data_loc = data_path + "raw_data/japser_norm_cube.mat"
    gt_loc = data_path + "raw_data/GroundTruth/end4.mat"
    abf_true_loc =  data_path + "raw_data/GroundTruth/end4.mat"
